...
/// or [CustomSimpleDialog], which implement specific kinds of material design
/// dialogs.
///
/// See also:
///
///  * [CustomAlertDialog], for dialogs that have a message and some buttons.
///  * [CustomSimpleDialog], for dialogs that offer a variety of options.
///  * [showCustomDialog], which actually displays the dialog and returns its result.
///  * <https://material.io/design/components/dialogs.html>
class CustomDialog extends StatelessWidget {
  /// Creates a dialog.
  ///
  /// Typically used in conjunction with [showCustomDialog].
  const CustomDialog({
    Key key,
...
/// using [CustomDialog] directly.)
///
/// For dialogs that offer the user a choice between several options, consider
/// using a [CustomSimpleDialog].
///
/// Typically passed as the child widget to [showCustomDialog], which displays the
/// dialog.
///
/// {@tool sample}
///
...
///       return AlertDialog(
///         title: TextApp('Rewind and remember'),
///         content: SingleChildScrollView(
///           child: ListBody(
///             children: <Widget>[
///               TextApp('You will never be satisfied.'),
///               TextApp('You\’re like me. I’m never satisfied.'),
///             ],
///           ),
///         ),
///         actions: <Widget>[
///           FlatButton(
///             child: TextApp('Regret'),
///             onPressed: () {
...
/// See also:
///
///  * [CustomSimpleDialog], which handles the scrolling of the contents but has no [actions].
///  * [CustomDialog], on which [CustomAlertDialog] and [CustomSimpleDialog] are based.
...
/// An option used in a [CustomSimpleDialog].
///
...
/// default [CustomSimpleDialog.contentPadding] so that each option ends up 8 pixels
...
///   child: const TextApp('Treasury department'),
/// )
/// ```
/// {@end-tool}
///
/// See also:
///
///  * [CustomSimpleDialog], for a dialog in which to use this widget.
///  * [showCustomDialog], which actually displays the dialog and returns its result.
...
class SimpleDialogOption extends StatelessWidget {
  /// Creates an option for a [CustomSimpleDialog].
  ...
  ///
  /// When used in a [CustomSimpleDialog], this will typically call [Navigator.pop]
  /// with a value for [showCustomDialog] to complete its future with.
...
/// options are represented as an enum. The [showCustomDialog] method here returns
...
///     builder: (BuildContext context) {
///       return SimpleDialog(
///         title: const TextApp('Select assignment'),
///         children: <Widget>[
///           SimpleDialogOption(
///             onPressed: () { Navigator.pop(context, Department.treasury); },
///             child: const TextApp('Treasury department'),
...
///             child: const TextApp('State department'),
///           ),
///         ],
///       );
///     }
...
///  * [CustomAlertDialog], for dialogs that have a row of buttons below the body.
///  * [CustomDialog], on which [CustomSimpleDialog] and [CustomAlertDialog] are based.
///  * [showCustomDialog], which actually displays the dialog and returns its result.
///  * <https://material.io/design/components/dialogs.html#simple-dialog>
...
///
/// This function takes a `builder` which typically builds a [CustomDialog] widget.
...
/// See also:
///
///  * [CustomAlertDialog], for dialogs that have a row of buttons below a body.
///  * [CustomSimpleDialog], which handles the scrolling of the contents and does
